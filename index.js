...
*/
console.log(createMenuItem('task 1b','pizza',2000,'dinner'))
console.log(createMenuItem('task 1b','pep izza',20,'breakfeast'))
console.log(createMenuItem('task 1b','cheese pizza',200,'lunch'))
...
function addReview(newObj, name, rating, feedback){
  newObj.push({name: name, 
                rating: rating, 
                feedback: feedback});
  return newObj;
  
}
addReview(reviews, 'Randy', 11, 'Amazing place to be!');
console.log(reviews);
...
function getReviewByIndex(array, arg) {
    return `${array[arg].name} gave the restaurant a ${array[arg].rating} star review, and their feedback was: ${array[arg].feedback}`
      }
